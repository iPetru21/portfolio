...
const earthModel = "/portfolio/assets/earth-DvZudj9K.glb";
const mwnx = "/portfolio/assets/milkyway-nx-Ds_hwpSC.hdr";
const mwny = "/portfolio/assets/milkyway-ny-BqhFvupA.hdr";
const mwnz = "/portfolio/assets/milkyway-nz-D6l6T-pv.hdr";
const mwpx = "/portfolio/assets/milkyway-px-BjIdbMt0.hdr";
const mwpy = "/portfolio/assets/milkyway-py-BD6pEbZF.hdr";
const mwpz = "/portfolio/assets/milkyway-pz-Bx3WFS88.hdr";
const milkywayBg = "/portfolio/assets/milkyway-Vkpv7LbT.jpg";
...
const Earth = ({
  ...
  const renderFrame = useCallback(() => {
    ...
    labelElements.current.forEach((label) => {
      const { element, position: position2, sprite } = label;
  ...
  useEffect(() => {
    ...
    const handleMouseUp = (event) => {
      ...
      if (intersects.length > 0) {
        positionToString(intersects[0].point);
      }
    };
