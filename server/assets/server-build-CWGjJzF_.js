...
const Carousel = lazy(
  () => import("./index-DWDidSWy.js").then((module) => ({ default: module.Carousel }))
);
const Armor = lazy(() => import("./armor-Bv68_zJN.js").then((module) => ({ default: module.Armor })));
...
const Earth$1 = lazy(() => import("./earth-BGr4vJTK.js").then((module) => ({ default: module.Earth })));
const EarthSection$1 = lazy(
  () => import("./earth-BGr4vJTK.js").then((module) => ({ default: module.EarthSection }))
);
...
const Earth = lazy(() => import("./earth-BGr4vJTK.js").then((module) => ({ default: module.Earth })));
...
const DisplacementSphere = lazy(
  () => import("./displacement-sphere-CM5_DYHC.js").then((module) => ({ default: module.DisplacementSphere }))
);
